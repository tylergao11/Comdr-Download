...
2. Bridge（Cocos Creator 扩展）：
   mkdir -p extensions
   curl -L -o extensions/comdr-bridge.zip https://comdr-download.pages.dev/download/comdr-bridge-v${VERSION}.zip
   unzip -o extensions/comdr-bridge.zip -d extensions/
   rm extensions/comdr-bridge.zip
   然后重启 Cocos Creator

3. View（桌面星图）：
   curl -L -o comdr-view.zip https://comdr-download.pages.dev/download/comdr-view-v${VERSION}.zip
