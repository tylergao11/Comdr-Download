  ...
  capabilities: [
    {
      ...
      bullets: [
        ...
        '四种查询原语——trace、look、who、find——连边查图，毫秒级响应',
        '增量刷新，项目切换即时可用',
    ...
    {
      icon: '⚡',
      title: 'AI 编辑器 — 精确的操作执行',
      summary:
        'Coding Agent 拆解需求、编排步骤。Comdr 将每一步实时翻译为编辑器命令并执行。',
      bullets: [
        'Commander 引擎将自然语言翻译为编辑器命令，自动匹配组件与属性',
        '写前自动快照，失败即回滚，每次写入保证项目完整性',
        '内置 233+ 引擎组件知识库，自动补全依赖与默认值',
